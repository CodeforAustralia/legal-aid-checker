...
$legal_help    = true;    // Choose true if client is eligigle to get legal help
?>
      ...
      <section id="content" role="main" class="group">
         ...
         <div class="done-questions">
            ...
            <ol>
               ...
               <li class="done">
                  <h3 class="question"><span class="question-number">2</span>     What is your family problem about?  
                  </h3>
                  <div class="answer"> Separation, divorce and marriage annulment</div>
