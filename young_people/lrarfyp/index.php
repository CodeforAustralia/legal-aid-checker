      ...
      <section id="content" role="main" class="group">
         ...
         <div class="done-questions">
            ...
            <ol>
               ...
               <li class="done">
                  <h3 class="question"><span class="question-number">2</span>What is your young people and the law problem about?  
                     
                  </h3>
                  <div class="answer">Legal rights and responsibilities for young people</div>
                  <p class="undo"><a href="/young_people">Change this answer</a></p>
               </li>
            </ol>
         </div><a name="c"></a>
         <?php
