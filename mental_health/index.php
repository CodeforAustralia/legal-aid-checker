         ...
         <div class="done-questions">
            ...
            <ol>
               <li class="done">
                  ...
                  <div class="answer">Mental health and disability </div>
                  <p class="undo"><a href="/">Change this answer</a></p>
               </li>
            </ol>
         </div><a name="c"></a><div class="step current">
            <form accept-charset="UTF-8" action="#" method="post" id="navigator"><input type="hidden" name="path" id="path" value="/mental_health"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="✓"></div>
               <div class="current-question" id="current-question">
                  <h2><span class="question-number">2</span>     What is your mental health problem about?  
                  </h2>
                     <div class="">
                        <ul class="options">
                           <li><label for="response_1"><input id="response_1" name="response" type="radio" value="gaao"> Guardianship and administration orders</label></li>
                           <li><label for="response_2"><input id="response_2" name="response" type="radio" value="mhayr"> Mental health and your rights</label></li>
                           <li><label for="response_3"><input id="response_3" name="response" type="radio" value="ndis"> National Disability Insurance Scheme</label></li>
