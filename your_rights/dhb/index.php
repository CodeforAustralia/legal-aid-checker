      ...
      <section id="content" role="main" class="group">
         ...
         <div class="done-questions">
            ...
            <ol>
               ...
               <li class="done">
                  <h3 class="question"><span class="question-number">2</span>What is your rights problem about?
                     
                  </h3>
                  <div class="answer">Discrimination, harassment and bullying</div>
                  <p class="undo"><a href="/your_rights">Change this answer</a></p>
               </li>
            </ol>
         </div><a name="c"></a>
         <?php
