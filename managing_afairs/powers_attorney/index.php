      ...
      <section id="content" role="main" class="group">
         ...
         <div class="done-questions">
            ...
            <ol>
               ...
               <li class="done">
                  <h3 class="question"><span class="question-number">2</span>What is your managing your affairs problem about?  
                     
                  </h3>
                  <div class="answer">Powers of attorney</div>
                  <p class="undo"><a href="/managing_afairs">Change this answer</a></p>
               </li>
            </ol>
         </div><a name="c"></a>
         <?php
